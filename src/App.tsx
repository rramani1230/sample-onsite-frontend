...
import type { TaskData } from './components/CreateTaskModal';
...
function App() {
  ...
  const handleOpenModal = (columnStatus: string) => {
    setSelectedColumn(columnStatus);
    setIsModalOpen(true);
  };

  const handleCreateTask = (task: TaskData) => {
    setTasks([...tasks, { ...task, status: selectedColumn }]);
  };
  ...
  const handleDrop = (e: React.DragEvent, newStatus: string) => {
    ...
    if (draggedTask) {
      setTasks(tasks.map(task => 
        task.title === draggedTask.title && task.status === draggedTask.status
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <Header onNewTaskClick={() => handleOpenModal('backlog')} />
        ...
        <main className="flex-1 overflow-x-auto overflow-y-hidden p-8">
          <div className="grid grid-cols-4 gap-6 h-full">
            ...
            <div 
              ...
              className={`bg-white rounded-2xl shadow-lg border-2 p-6 flex flex-col min-h-0 transition-all ${
            ...
            >
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-xs font-bold text-gray-500 bg-gray-100 px-3 py-1.5 rounded-full">{backlogTasks.length}</span>
              ...
              <div className="flex-1 space-y-3 overflow-y-auto mb-4">
                {backlogTasks.length === 0 ? (
                  ...
                  backlogTasks.map((task, index) => (
                    <TaskCard key={index} task={task} onDragStart={handleDragStart} />
                  ))
                )}
              </div>
              ...
              <button 
                ...
                className="flex items-center justify-center gap-2 w-full py-3 text-sm font-medium text-gray-600 hover:bg-gray-50 rounded-xl transition-all border-2 border-dashed border-gray-300 hover:border-gray-400"
              >
                <Plus size={18} />
                Add Task
              </button>
            ...
            >
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-xs font-bold text-blue-600 bg-blue-100 px-3 py-1.5 rounded-full">{inProgressTasks.length}</span>
                  <button className="p-1.5 hover:bg-gray-100 rounded-lg transition-colors">
                    <MoreHorizontal size={18} className="text-gray-400" />
                  </button>
                </div>
              ...
              <button 
                ...
                className="flex items-center justify-center gap-2 w-full py-3 text-sm font-medium text-blue-600 hover:bg-blue-50 rounded-xl transition-all border-2 border-dashed border-blue-300 hover:border-blue-400"
              >
                <Plus size={18} />
                Add Task
              </button>
            ...
            >
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-xs font-bold text-yellow-600 bg-yellow-100 px-3 py-1.5 rounded-full">{reviewTasks.length}</span>
                  <button className="p-1.5 hover:bg-gray-100 rounded-lg transition-colors">
                    <MoreHorizontal size={18} className="text-gray-400" />
                  </button>
                </div>
              ...
              <button 
                ...
                className="flex items-center justify-center gap-2 w-full py-3 text-sm font-medium text-yellow-600 hover:bg-yellow-50 rounded-xl transition-all border-2 border-dashed border-yellow-300 hover:border-yellow-400"
              >
                <Plus size={18} />
                Add Task
              </button>
            ...
            >
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-xs font-bold text-green-600 bg-green-100 px-3 py-1.5 rounded-full">{doneTasks.length}</span>
                  <button className="p-1.5 hover:bg-gray-100 rounded-lg transition-colors">
                    <MoreHorizontal size={18} className="text-gray-400" />
                  </button>
                </div>
              ...
              <button 
                ...
                className="flex items-center justify-center gap-2 w-full py-3 text-sm font-medium text-green-600 hover:bg-green-50 rounded-xl transition-all border-2 border-dashed border-green-300 hover:border-green-400"
              >
                <Plus size={18} />
                Add Task
              </button>
